...
echo "$(echo deb mirror://mirrors.ubuntu.com/mirrors.txt xenial main restricted universe multiverse | cat - /etc/apt/sources.list)" > /etc/apt/sources.list
echo "$(echo deb mirror://mirrors.ubuntu.com/mirrors.txt xenial-updates main restricted universe multiverse | cat - /etc/apt/sources.list)" > /etc/apt/sources.list
echo "$(echo deb mirror://mirrors.ubuntu.com/mirrors.txt xenial-backports main restricted universe multiverse | cat - /etc/apt/sources.list)" > /etc/apt/sources.list
echo "$(echo deb mirror://mirrors.ubuntu.com/mirrors.txt xenial-security main restricted universe multiverse | cat - /etc/apt/sources.list)" > /etc/apt/sources.list
